...
(https://arxiv.org/pdf/1801.00868.pdf). Two labels are
assigned to each pixel of a segment:
...
from panopticapi.utils import IdGenerator, get_traceback, save_json
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        ...
        stored in 2 channels panoptic format to COCO panoptic format. \
        See this file's head for more information.")
    parser.add_argument(
        '--source_folder',
        type=str,
